...
load_dotenv(dotenv_path='../../../Downloads/AI-Agents-for-Medical-Diagnostics-main/apikey.env')

# read the medical report
with open(
        "../../../Downloads/AI-Agents-for-Medical-Diagnostics-main/Medical Reports/Medical Rerort - Michael Johnson - Panic Attack Disorder.txt", "r") as file:
